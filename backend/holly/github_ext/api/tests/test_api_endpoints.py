...
class GitHubAPITestCase(TestCase):
        ...
        self.mock_repo_data = [
            {
                ...
                "full_name": "testuser/test-repo-public",
                "owner": {
                    "login": "testuser",
                    "id": 12345,
                    "avatar_url": "https://avatars.githubusercontent.com/u/12345?v=4",
                },
                "html_url": "https://github.com/testuser/test-repo-public",
            ...
            },
            {
                ...
                "full_name": "testuser/test-repo-private",
                "owner": {
                    "login": "testuser",
                    "id": 12345,
                    "avatar_url": "https://avatars.githubusercontent.com/u/12345?v=4",
                },
                "html_url": "https://github.com/testuser/test-repo-private",
    ...
    def test_list_repositories_endpoint(self, mock_list_repositories):
        ...
        assert response_data[0]["name"] == "test-repo-public"
        assert response_data[0]["private"] is False
        assert response_data[1]["name"] == "test-repo-private"
        assert response_data[1]["private"] is True

    @patch("holly.github_ext.services.github_app_service.GitHubAppService.list_repositories")
    def test_list_repositories_private_only(self, mock_list_repositories):
        """Test the list repositories endpoint with private_only filter."""
        # Configure mock to return test data
        mock_list_repositories.return_value = self.mock_repo_data

        # Make request to API endpoint with private_only filter
        response = self.client.get("/_api/github/repositories?private_only=true")

        # Assertions
        assert response.status_code == 200
        response_data = json.loads(response.content)
        assert len(response_data) == 1
        assert response_data[0]["name"] == "test-repo-private"
        assert response_data[0]["private"] is True
